...
// sendgrid for email
// require on top
sgMail.setApiKey('SG.3b9WtkqhReSIZWrCCcbrGw.8K62TnPZ1T6Ckh-nIK45wXF-4Ggkj1ooAaaj9LVE4a0SG.PhtsRN0pSzWj8hVUEPIqZA.6hcPA0ynz5qHKDtknjmEd1eXV1lIBmAqBZuCoI3x6sI');
...
exports.create = (req, res) => {
    ...
    order.save((error, data) => {
        ...
        // order.amount
        const emailData = {
            to: 'kumsettynikhilvenkat.181it224@nitk.edu.in', // admin
